...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Thanh Tung MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://th.bing.com/th/id/OIP.s08bNq8BPNABdU3eOkdBQgHaFj?rs=1&pid=ImgDetMain',
      ...
      },
      {
        ...
        cardOrderIds: ['columnId-04-placeholder-card'],
        cards: [
          { _id: 'columnId-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04', FE_PlaceholderCard: true }
        ]
      }
    ]
  }
